...
def init_model(args):
    ...
    print(f'Số tham số mô hình MiniMind: {sum(p.numel() for p in model.parameters()) / 1e6:.2f} M (triệu)')
...
class ChatRequest(BaseModel):
    ...
    def get_open_thinking(self) -> bool:
        """Tương thích nhiều cách bật thinking"""
...
if __name__ == "__main__":
    ...
    parser.add_argument('--weight', default='full_sft', type=str, help="Tiền tố tên trọng số (pretrain, full_sft, dpo, reason, ppo_actor, grpo, spo)")
    ...
    parser.add_argument('--max_seq_len', default=8192, type=int, help="Độ dài chuỗi tối đa")
