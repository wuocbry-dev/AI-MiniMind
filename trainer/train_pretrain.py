...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_weight', default='pretrain', type=str, help="Tiền tố tên trọng số lưu")
    parser.add_argument("--epochs", type=int, default=2, help="Số epoch huấn luyện")
    parser.add_argument("--batch_size", type=int, default=32, help="batch size")
    parser.add_argument("--learning_rate", type=float, default=5e-4, help="Learning rate ban đầu")
    ...
    parser.add_argument("--accumulation_steps", type=int, default=8, help="Số bước tích lũy gradient")
    ...
    parser.add_argument("--data_path", type=str, default="../dataset/pretrain_t2t_mini.jsonl", help="Đường dẫn dữ liệu tiền huấn luyện")
    parser.add_argument('--from_weight', default='none', type=str, help="Huấn luyện dựa trên trọng số nào; nếu 'none' thì bắt đầu từ đầu")
    ...
    parser.add_argument("--wandb_project", type=str, default="MiniMind-Pretrain", help="Tên dự án wandb")
