...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_weight', default='grpo', type=str, help="Tiền tố tên trọng số lưu")
    parser.add_argument("--epochs", type=int, default=1, help="Số epoch huấn luyện")
    parser.add_argument("--batch_size", type=int, default=2, help="batch size")
    parser.add_argument("--learning_rate", type=float, default=3e-7, help="Learning rate ban đầu")
    ...
    parser.add_argument('--max_seq_len', default=768, type=int, help="Độ dài tối đa của prompt")
    ...
    parser.add_argument("--num_generations", type=int, default=6, help="Số mẫu sinh cho mỗi prompt")
    ...
    parser.add_argument("--wandb_project", type=str, default="MiniMind-GRPO", help="Tên dự án wandb")
    parser.add_argument("--use_compile", default=0, type=int, choices=[0, 1], help="Có dùng torch.compile để tăng tốc (0=không, 1=có)")
    parser.add_argument("--debug_mode", action="store_true", help="Có in mẫu debug khi huấn luyện")
    parser.add_argument("--debug_interval", type=int, default=20, help="Trong chế độ debug, in mẫu mỗi bao nhiêu step")
    ...
    parser.add_argument("--sglang_shared_path", type=str, default="./sglang_ckpt_grpo", help="Đường dẫn lưu trữ dùng chung của SGLang")
